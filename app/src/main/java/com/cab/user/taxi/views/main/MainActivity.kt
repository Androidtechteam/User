        ...
        withContext(Dispatchers.IO) {
            ...
            if (routes != null) {
                for (i in routes.indices) {
                    ...
                    lineOptions.color(ContextCompat.getColor(this@MainActivity, R.color.cabme_app_yellow))
    ...
    private fun Updatepolyline(driverlatlng: LatLng) {
        ...
        if (!isonPath) {
            ...
            if (newPoints.size > 0) {
                ...
                lineOptions.width(8f)
                lineOptions.color(ContextCompat.getColor(this, R.color.cabme_app_yellow))
                lineOptions.geodesic(true)
                polyline?.remove()
